...
from pris3.deep3d_facerecon.util.load_mats import transferBFM09
import os
...
class ParametricFaceModel:
    def __init__(self, 
        ...
        self.keypoints_468 = np.load(os.path.join(bfm_folder,"index_mp468_from_mesh35709.npy")).astype(np.int64)
    ...
    def get_landmarks_468(self, face_proj):
        return face_proj[:, self.keypoints_468]
    ...
    def compute_for_render(self, coeffs):
        ...
        #print('bfm', coef_dict['id'][0].dtype, coef_dict['exp'][0].dtype)
        ...
        landmark_468 = self.get_landmarks_468(face_proj)
        ...
        return face_vertex, face_texture, face_color, landmark, landmark_468
